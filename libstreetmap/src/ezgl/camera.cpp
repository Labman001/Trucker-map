...
void camera::reset_initial_world(ezgl::rectangle new_world){
    m_initial_world=new_world;
    update_scale_factors();
}
 void camera::update_m_screeen(rectangle new_screen){
     m_screen=new_screen;
 }
void camera::public_update_widget(double width, double height){
    m_widget = rectangle{{0, 0}, width, height};
